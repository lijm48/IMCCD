...
def llava_attn(self, query, key, value, attention_mask=None, head_mask=None, attention_adapter=None):
    attn_weights = torch.matmul(query, key.transpose(-1, -2))
...
class LLaVaAttentionerManager(AttentionerManagerBase):
    def __init__(self, model: PreTrainedModel):
    ...
    def register_attentioner_to_model(self):
        ...
        for i, layer in enumerate(self.model.layers):
            ...
            # import pdb;pdb.set_trace()
            layer.self_attn = partial(llava_attn, layer.self_attn,
