...
parser.add_argument('--eval_type', default='hallucination', type=str)

eval_type_dict = {
    "Perception": ["existence", "count", "position", "color", "posters", "celebrity", "scene", "landmark", "artwork", "OCR"],
    "Cognition": ["commonsense_reasoning", "numerical_calculation", "text_translation", "code_reasoning"]
}
eval_type_dict_hallucination = {
...
class calculate_metrics:
    ...
    def process_result(self, results_dir, all_eval_type):

        model_score_dict = dict()
        cur_eval_type_dict = eval_type_dict
        if all_eval_type == 'hallucination':
            cur_eval_type_dict = eval_type_dict_hallucination
        for eval_type, task_name_list in cur_eval_type_dict.items():
            print("===========", eval_type, "===========")
...
if __name__ == "__main__":
    ...
    cal.process_result(results_dir, eval_type)