...
--question-file ../../../data/MME_Benchmark_release_version/mme_hallucination.jsonl \
--image-folder ${image_folder} \
--answers-file ./output/${dataset_name}/llava15_${dataset_name}_answers_imccd_seed${seed}.jsonl \
--cd_alpha $cd_alpha \
--cd_beta $cd_beta \
--use_cd \
--use_mask \
...
python ./eval/convert_answer_to_mme.py \
--output_path ./output/${dataset_name}/llava15_${dataset_name}_answers_imccd_seed${seed}.jsonl \
--seed ${seed} \
--log_path ./output/${dataset_name}/llava15_${dataset_name}_answers_imccd_seed${seed}/ \