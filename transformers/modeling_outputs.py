...
@dataclass
class BaseModelOutputWithPastIMCCD(ModelOutput):
    """
    Base class for model's outputs that may also contain a past key/values (to speed up sequential decoding).
    ...
    hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    attentions: Optional[Tuple[torch.FloatTensor]] = None
    past_key_values_without_pos: Optional[Tuple[Tuple[torch.FloatTensor]]] = None
...
@dataclass
class CausalLMOutputWithPastIMCCD(ModelOutput):
    """
    Base class for causal language model (or autoregressive) outputs.
...
@dataclass
class CausalLMOutputWithMask(ModelOutput):
    """
    Base class for causal language model (or autoregressive) outputs.
    ...
    hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    attentions: Optional[Tuple[torch.FloatTensor]] = None
    mask_sum: Optional[Tuple[torch.FloatTensor]] = None
