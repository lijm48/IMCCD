...
class GenerationMixin:
    ...
    def _extract_past_from_model_output_without_pos(self, outputs: ModelOutput, standardize_cache_format: bool = False):
        past_key_values = None
        if "past_key_values_without_pos" in outputs:
            past_key_values = outputs.past_key_values_without_pos
        elif "mems" in outputs:
            past_key_values = outputs.mems
        elif "past_buckets_states" in outputs:
            past_key_values = outputs.past_buckets_states
    ...
    def _update_model_kwargs_for_generation(
        ...
        model_kwargs["past_key_values_without_pos"] = self._extract_past_from_model_output_without_pos(
            outputs, standardize_cache_format=standardize_cache_format
        )
